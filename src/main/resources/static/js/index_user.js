...
document.getElementById("myHeader").innerHTML =
    ...
    "<div class='col-md-1 id = text_M1'><a class = 'menu-item' style= 'text-decoration: none;' href='/cart'>корзина </a></div>"+
    "<div class='col-md-1 id = text_M1'><a class = 'menu-item' style= 'text-decoration: none;' href='/orders'>история заказов </a></div>"+
    "<div class='col-md-1 id = text_M2'" +
    "      <form method= 'post' action='/logout'>" +
    "        <a class = 'menu-item' style= 'text-decoration: none;' href='/product'>выйти</a>" +
    "      </form>" +
    "     </div>"+
    "</div></div>"+
    "<div class='kontainer'>"+
