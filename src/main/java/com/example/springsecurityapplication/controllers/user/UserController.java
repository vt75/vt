...
public class UserController {
    ...
    public UserController(ProductService productService, OrderRepository orderRepository, CartRepository cartRepository) {
    ...
    public String index(Model model) {
        ...
        model.addAttribute("user",personDetails.getUsername());
